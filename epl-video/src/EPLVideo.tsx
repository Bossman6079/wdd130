...
const SCENES = [
  180,  // 0  Title card              (6s)
  420,  // 1  What is the EPL         (14s)
  420,  // 2  Birth 1992              (14s)
  420,  // 3  Man Utd 1993            (14s)
  360,  // 4  Blackburn 1995          (12s)
  420,  // 5  Fergie dynasty          (14s)
  540,  // 6  The Treble 1999         (18s)
  420,  // 7  United 2000-03          (14s)
  480,  // 8  Arsenal Invincibles     (16s)
  420,  // 9  Chelsea revolution      (14s)
  420,  // 10 United return 07-09     (14s)
  300,  // 11 City takeover 2008      (10s)
  540,  // 12 Agüero 93:20 - 2012     (18s)
  360,  // 13 Liverpool near miss 14  (12s)
  600,  // 14 Leicester miracle 2016  (20s)
  420,  // 15 City 100 points 2018    (14s)
  420,  // 16 Liverpool 2020          (14s)
  480,  // 17 City treble 2023        (16s)
  480,  // 18 Champions table         (16s)
  420,  // 19 Records                 (14s)
  480,  // 20 Outro                   (16s)
] as const; // Total: 9000 frames = 300 seconds = 5 minutes
...
export const TOTAL_FRAMES = SCENES.reduce((a, b) => a + b, 0); // 9000
...
export const EPLVideo: React.FC = () => {
  return (
    <AbsoluteFill>
      {/* Background music */}
      <Audio src={staticFile("bg-music.wav")} volume={0.65} />
      ...
      <Sequence from={STARTS[1]} durationInFrames={SCENES[1]}>
        <MomentScene
          ...
          visual={
            <StatPanel
              stat="20"
              label="Clubs · 380 matches per season"
              color={BLUE}
              subLabel="3 up · 3 down"
              emoji="⚽"
            />
          }
      ...
      <Sequence from={STARTS[2]} durationInFrames={SCENES[2]}>
        <MomentScene
          ...
          championColor={BLUE}
          facts={[
            "On 20 February 1992, the Football Association approved the formation of the Premier League as a separate entity.",
          ...
          visual={
            <StatPanel
              stat="£304M"
              label="First TV deal · BSkyB 1992"
              color={BLUE}
              subLabel="Changed football forever"
            />
          }
      ...
      <Sequence from={STARTS[3]} durationInFrames={SCENES[3]}>
        <MomentScene
          ...
          visual={
            <TrophyPanel count={2} label="First two Premier League titles" color="#DA020E" />
          }
      ...
      <Sequence from={STARTS[4]} durationInFrames={SCENES[4]}>
        <MomentScene
          ...
          facts={[
            ...
            "Alan Shearer scores 34 Premier League goals in the title season — a then-record.",
            "Blackburn clinch the title on the final day of the season as Manchester United drop points at West Ham.",
            "It remains Blackburn Rovers' only top-flight title — and one of the great underdog stories.",
          ]}
          visual={
            <StatPanel
              stat="34"
              label="Shearer's goals · 1994–95"
              color="#009EE0"
              subLabel="A then Premier League record"
              emoji="🥅"
            />
          }
      ...
      <Sequence from={STARTS[5]} durationInFrames={SCENES[5]}>
        <MomentScene
          ...
          visual={
            <TrophyPanel count={5} label="United titles · 1993 to 2001" color="#DA020E" />
          }
      ...
      <Sequence from={STARTS[6]} durationInFrames={SCENES[6]}>
        <MomentScene
          ...
          facts={[
            ...
            "Sir Alex Ferguson is knighted that summer. It remains the greatest season in English club football.",
          ]}
          visual={
            <StatPanel
              stat="91+3"
              label="Solskjær scores — 1999 CL Final"
              color="#DA020E"
              subLabel="The most dramatic comeback in football"
              emoji="🏆"
            />
          }
      ...
      <Sequence from={STARTS[7]} durationInFrames={SCENES[7]}>
        <MomentScene
          ...
          facts={[
            ...
            "Arsenal break the run in 2001–02, with Thierry Henry and Patrick Vieira leading the Gunners to a Double.",
            "United return in 2002–03: Ruud van Nistelrooy scores 25 league goals as they reclaim the title.",
            "By 2003, United have won 8 of the first 11 Premier League titles. No club has dominated like this since.",
          ]}
          visual={
            <TrophyPanel count={8} label="PL titles in first 11 seasons" color="#DA020E" />
          }
      ...
      <Sequence from={STARTS[8]} durationInFrames={SCENES[8]}>
        <MomentScene
          ...
          facts={[
            ...
            "The unbeaten run eventually stretches to 49 games across two seasons — still an all-time English record.",
          ]}
          visual={
            <StatPanel
              stat="49"
              label="Consecutive unbeaten league games"
              color="#EF0107"
              subLabel="An all-time English football record"
              emoji="🔴"
            />
          }
      ...
      <Sequence from={STARTS[9]} durationInFrames={SCENES[9]}>
        <MomentScene
          ...
          facts={[
            "June 2003: Russian billionaire Roman Abramovich purchases Chelsea for £140m, transforming English football.",
            "In 18 months, Chelsea spend over £150m on players — Robben, Drogba, Essien, Makelele, Cech.",
          ...
          visual={
            <StatPanel
              stat="95"
              label="Points in 2004–05 title season"
              color="#4F7FBE"
              subLabel="15 goals conceded — a PL defensive record"
            />
          }
      ...
      <Sequence from={STARTS[10]} durationInFrames={SCENES[10]}>
        <MomentScene
          ...
          championColor="#DA020E"
          facts={[
            "A new generation arrives at Old Trafford: Rooney, Ronaldo, Tevez and Ferdinand form a formidable squad.",
            "Cristiano Ronaldo wins the Ballon d'Or in 2008 after scoring 42 goals in all competitions.",
            "2007–08: United win the Premier League and the Champions League — a second European Treble haul.",
            "Three consecutive league titles (2007, 08, 09) equal their own record set in the Treble era.",
          ]}
          visual={
            <StatPanel
              stat="42"
              label="Ronaldo goals in 2007–08"
              color="#DA020E"
              subLabel="Ballon d'Or · Champions League winner"
              emoji="⭐"
            />
          }
      ...
      <Sequence from={STARTS[11]} durationInFrames={SCENES[11]}>
        <MomentScene
          ...
          visual={
            <StatPanel
              stat="£210M"
              label="Abu Dhabi takeover · 2008"
              color="#6CABDD"
              subLabel="The start of a new era"
            />
          }
      ...
      <Sequence from={STARTS[12]} durationInFrames={SCENES[12]}>
        <MomentScene
          ...
          facts={[
            ...
            "Martin Tyler's commentary — 'AGUEROOOO!' — is one of the most iconic moments in sports broadcasting history.",
          ]}
          visual={
            <StatPanel
              stat="93:20"
              label="Agüero's title-winning goal"
              color="#6CABDD"
              subLabel="Man City 3–2 QPR · 13 May 2012"
              emoji="💙"
            />
          }
      ...
      <Sequence from={STARTS[13]} durationInFrames={SCENES[13]}>
        <MomentScene
          ...
          facts={[
            ...
            "City take advantage to win the title by 2 points. Liverpool finish with 84 points — still not enough.",
          ]}
          visual={
            <StatPanel
              stat="2 PTS"
              label="Liverpool's title margin miss · 2014"
              color="#C8102E"
              subLabel="84 points — and still not enough"
              emoji="😞"
            />
          }
      ...
      <Sequence from={STARTS[14]} durationInFrames={SCENES[14]}>
        <MomentScene
          ...
          facts={[
            ...
            "Vardy breaks the record for scoring in 11 consecutive Premier League games — a mark later equalled.",
            "They win the title with two games to spare — universally celebrated as the greatest sporting upset ever.",
          ]}
          visual={
            <StatPanel
              stat="5000/1"
              label="Pre-season title odds"
              color="#FDBE11"
              subLabel="The greatest sporting upset of all time"
              emoji="🦊"
            />
          }
      ...
      <Sequence from={STARTS[15]} durationInFrames={SCENES[15]}>
        <MomentScene
          ...
          facts={[
            ...
            "They also score 106 goals — the most ever in a Premier League season — with Kevin De Bruyne pulling strings.",
            "City finish 19 points ahead of second-placed United. It is the most dominant title victory in PL history.",
          ]}
          visual={
            <StatPanel
              stat="100"
              label="Record points in a PL season"
              color="#6CABDD"
              subLabel="City 2017–18 · 19 points clear"
              emoji="🔵"
            />
          }
      ...
      <Sequence from={STARTS[16]} durationInFrames={SCENES[16]}>
        <MomentScene
          ...
          championColor="#C8102E"
          facts={[
            "Jürgen Klopp's Liverpool finally end their 30-year wait for a league title, wrapping it up with seven games to spare.",
            "Liverpool finish with 99 points — the second-highest total in Premier League history.",
            "The season is played partly behind closed doors due to the COVID-19 pandemic — a historic and surreal backdrop.",
            "Mohamed Salah, Sadio Mané, Roberto Firmino and a rock-solid defence power Liverpool all season.",
          ]}
          visual={
            <StatPanel
              stat="30"
              label="Years since their last league title"
              color="#C8102E"
              subLabel="2019–20 champions · 99 points"
              emoji="🔴"
            />
          }
      ...
      <Sequence from={STARTS[17]} durationInFrames={SCENES[17]}>
        <MomentScene
          ...
          facts={[
            ...
            "City have now won 7 Premier League titles since 2012 — more than any other club in the post-2010 era.",
          ]}
          visual={
            <StatPanel
              stat="36"
              label="Haaland PL goals · debut season 2022–23"
              color="#6CABDD"
              subLabel="A new Premier League record"
              emoji="🏆"
            />
          }
